"""
langchain_mcp_client_openai.py
...
This file implements an MCP client that:
  ...
  - Instantiates the ChatOpenAI model (OpenAI) using your OPENAI_API_KEY.
...
from contextlib import AsyncExitStack # Ensures all async resources are properly closed (not used directly here)
...
# LLM Instantiation
# ---------------------------
# Create an instance of the OpenAI chat model via LangChain.
llm = ChatOpenAI(
    model="gpt-4o-mini",              # Cheaper OpenAI model choice
